...
function progress(){
		...
		if (ajax.readyState == 4 && ajax.status == 200) {
			...
			valeur+=10;
			$('.progress-bar').css('width', value+'%').attr('aria-valuenow', valeur);
			progressing();
	  	}
	};
		ajax.open("POST", "languagerunon-storm.php",true);
		ajax.send();
}
...
<a id="link" href="http://172.24.42.7:8080" target="_blank">Click here...</a> <br>
